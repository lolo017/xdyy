package aisino.reportform.service.impl;
...
public class BaseServiceImpl<T> implements BaseServiceI<T> {
	...
	@Override
	public void update(T o,boolean withTX) {
		baseDao.update(o,withTX);
	}
	...
	public List<T> find(String hql,boolean flush) {
		return baseDao.find(hql,flush);
	}
	@Override
	...
	public int executeSql(String sql,boolean withTx) {
		return baseDao.executeSql(sql,withTx);
	}
	@Override
