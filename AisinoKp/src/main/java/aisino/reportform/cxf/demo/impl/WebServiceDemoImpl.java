package aisino.reportform.cxf.demo.impl;
...
import aisino.reportform.cxf.demo.WebServiceDemoI;
 ...
 * 
 */
@WebService(endpointInterface = "aisino.reportform.cxf.demo.WebServiceDemoI", serviceName = "webServiceDemo")
