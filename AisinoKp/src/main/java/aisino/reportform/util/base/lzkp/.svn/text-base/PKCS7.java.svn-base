...
import static aisino.reportform.util.base.lzkp.CaConstant.DEFAULT_CHARSET;
...
//            }
    ...
    public static void main(String[] args) throws Exception {
      ...
      //  平台端解密过程 :平台端私钥(pfx)、pwd
        ...
        final byte[] decodeData = pkcs7Platform.pkcs7Decrypt(Base64Helper.decode(base64Date));
       ...
       final String source2 = "姆神要吃巧克力";
        ...
        final byte[] base64Data2 = Base64Helper.encode(encodeData2);
        String encodeText2= new String(base64Data2);
        ...
        final byte[] decodeData2 = pkcs7Client2.pkcs7Decrypt(Base64Helper.decodeByte(base64Data2));
