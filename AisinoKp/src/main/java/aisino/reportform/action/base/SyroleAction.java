...
public class SyroleAction extends BaseAction<Syrole> {
	 ...
	 * 获得当前用户的主要角色（主舱）
	 */
	public void doNotNeedSecurity_getMainRoleByUserId() {
		String sql="select t.main_role as id,tt.name from syuser t left join syrole tt on t.main_role=tt.id where t.id='"+id+"'";
