...
// String easyuiTheme = "material";//指定如果用户未选择样式，那么初始化一个默认样式
// String easyuiTheme = "default";
String easyuiTheme = "bootstrap";
...
var crm_ip="http://192.168.88.241:9002";
var localhost="http://localhost:8080/AisinoReportForm";
var sy = sy || {};
...
<%-- 引入自定义的JS--%>
<script type="text/javascript" src="<%=contextPath%>/jslib/asinoJs.js" charset="utf-8"></script>
...
// 	out.println("<script src='" + contextPath + "/jslib/jquery.min.js' type='text/javascript' charset='utf-8'></script>");
// } else {
// 	out.println("<script src='" + contextPath + "/jslib/jquery.min.js' type='text/javascript' charset='utf-8'></script>");
// }
out.println("<script src='" + contextPath + "/jslib/jquery.min.js' type='text/javascript' charset='utf-8'></script>");
out.println("<script src='" + contextPath + "/jslib/jquery-migrate-1.1.1.min.js' type='text/javascript' charset='utf-8'></script>");
out.println("<script src='" + contextPath + "/jslib/jquery.jqprint.js' type='text/javascript' charset='utf-8'></script>");
%>

<%-- 引入jquery扩展 --%>
<script src="<%=contextPath%>/jslib/syExtJquery.js?version=<%=version%>" type="text/javascript" charset="utf-8"></script>
<script src="<%=contextPath%>/jslib/validate.js" type="text/javascript" charset="utf-8"></script>
<%-- 引入Highcharts --%>
...
<link rel="stylesheet"  href="<%=contextPath%>/jslib/plupload-2.0.0/js/jquery.plupload.queue/css/jquery.plupload.queue.css" type="text/css"></link>
<script type="text/javascript" src="<%=contextPath%>/jslib/plupload-2.0.0/js/jquery.plupload.queue/jquery.plupload.queue.js"></script>
...
<!-- 晏俊凯修改的EASYUI样式 -->
<link id="easyuiTheme" rel="stylesheet" href="<%=contextPath%>/jslib/jquery-easyui-1.3.4/themes/EasyUITweak.css" type="text/css">
<link id="easyuiTheme" rel="stylesheet" href="<%=contextPath%>/style/YJKStyle.css" type="text/css">
...
<script src='<%=contextPath%>/jslib/jquery.base64.js'></script>
<script src='<%=contextPath%>/jslib/CharsetUtil.js'></script>