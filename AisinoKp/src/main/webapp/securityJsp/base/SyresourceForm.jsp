									...
									$('form')
											.form(
													'load',
													{
														...
														'data.seq' : result.seq,
														'data.manage_active' : result.manage_active,
			...
			<table class="table" style="width: 100%;">
				...
				<tr>
					...
					<td><select name="data.syresourcetype.id"
						...
						data-options="required:true,editable:false,valueField:'id',textField:'name',url:'<%=contextPath%>/base/syresourcetype!doNotNeedSecurity_combobox.sy',panelHeight:'10px'"
				...
				<tr>
					...
					<th>属性</th>
					<td ><select name="data.manage_active"
						class="easyui-combobox"
						data-options="required:true,editable:false,panelHeight:'10px'"
						style="width: 155px;">
						<option value="1">驾驶舱</option>
						<option value="2">操作舱</option>
						</select></td>
				</tr>
			</table>
		</fieldset>
