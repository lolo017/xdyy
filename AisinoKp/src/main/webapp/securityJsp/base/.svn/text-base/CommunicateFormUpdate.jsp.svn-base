		...
		<fieldset>
			...
			<table class="table" style="width: 100%;">
				<tr>
					...
					<textarea style="width: 100%; height: 81px;" name="data.sjgt"></textarea></td>
					...
					<td><textarea style="width:100%; height: 81px;" name="data.fgldgt"></textarea></td>
				<th style="text-align:center;">评价</th>
					<td><textarea style="width: 100%; height: 81px;" name="data.hzhbgt"></textarea></td>
				</tr>
				<tr>
					<th style="text-align:center;">与下级沟通</th>
					<td><textarea style="width: 100%; height: 81px;" name="data.xjgt"></textarea></td>
					<th style="text-align:center;">评价</th>
					<td><textarea style="width: 100%; height: 81px;" name="data.hzhbgt"></textarea></td>
					</tr>
					<tr>
					<th style="text-align:center;">与分子公司沟通</th>
					<td><textarea style="width: 100%; height: 81px;" name="data.gzgsgt"></textarea></td>
				<th style="text-align:center;">评价</th>
					<td><textarea style="width: 100%; height: 81px;" name="data.hzhbgt"></textarea></td>
				</tr>
				<tr>
				<th style="text-align:center;">与其它部门沟通</th>
				<td><textarea style="width: 100%; height: 81px;" name="data.qtbmgt"></textarea></td>
				<th style="text-align:center;">评价</th>
					<td><textarea style="width: 100%; height: 81px;" name="data.hzhbgt"></textarea></td>
				</tr>
					<tr>
