...
$(function() {
	grid = $('#grid').datagrid({
		title : '',
		url : sy.contextPath +  '/base/jxbm!gridDistinct.sy',
		/*queryParams:{
			empId:empId
		},*/
		//method:'get',
                 ...
                 },
                 {
          	      ...
          	      /*   formatter : function(value,row) {
                     ...
                     {  title : '操作',
  					...
  					<%}%>
  					<%if (securityUtil.havePermission("/base/performance!update1")) {%>
  ...
  function  editPer1(id) {
	var dialog = parent.sy.modalDialog({
		title : '编辑绩效信息',
		url : sy.contextPath + '/securityJsp/base/EditPerformanceFormGr.jsp?id=' + id,
		width:1000,
		height:600,
		buttons : [ {
			text : '保存',
